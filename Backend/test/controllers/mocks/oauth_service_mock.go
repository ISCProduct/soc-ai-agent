...
func (m *OAuthServiceMock) HandleGoogleCallback(ctx context.Context, code string) (*auth.AuthResponse, error) {
...
func (m *OAuthServiceMock) HandleGitHubCallback(ctx context.Context, code string) (*auth.AuthResponse, error) {
	args := m.Called(ctx, code)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}

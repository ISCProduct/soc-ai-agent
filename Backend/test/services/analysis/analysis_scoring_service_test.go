...
func TestBuildAnalysisSummary_WithLLM(t *testing.T) {
	...
	svc := analysis.NewAnalysisScoringService(scoreRepo, chatRepo, nil, convRepo, nil, nil, nil, aiClient, nil)
...
func TestRuleBasedFutureAnalyzerScore(t *testing.T) {
	analyzer := analysis.NewRuleBasedFutureAnalyzer()
...
func TestBuildScoreComment(t *testing.T) {
	tests := []struct {
		name     string
		scores   analysis.AnalysisScores
		contains []string
	}{
		{
			name:   "未評価コメント",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := analysis.BuildScoreComment(tt.scores)
...
func TestBuildJobSuitabilityComment(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			comment, roles := analysis.BuildJobSuitabilityComment(tt.scores)
...
func TestParseEmbedding(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := analysis.ParseEmbedding(tt.raw)
			if tt.wantError {
				if err == nil {
...
func TestCosineSimilarityService(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := analysis.CosineSimilarity(tt.a, tt.b)
...
func TestAverageCategoryScore(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := analysis.AverageCategoryScore(tt.scoreMap, tt.categories)
			if math.Abs(got-tt.want) > 1e-9 {

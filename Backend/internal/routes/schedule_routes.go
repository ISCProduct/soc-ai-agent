...
func SetupScheduleRoutes(api *echo.Group, scheduleController *schedulecontrollers.ScheduleController, userSecret string, access auth.UserAccessGuard, orgs OrganizationIDResolver) {

...
func SetupCollectiveInsightRoutes(api *echo.Group, controller *insightcontrollers.CollectiveInsightController, userSecret string, access auth.UserAccessGuard, orgs OrganizationIDResolver) {

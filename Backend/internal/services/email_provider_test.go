...
func TestEmailService_SendAnalysisReport_HTML(t *testing.T) {
	...
	summary := &AnalysisSummary{
		Scores:   AnalysisScores{JobScore: 0.8, InterestScore: 0.7, AptitudeScore: 0.6, FutureScore: 0.5},
		Progress: AnalysisProgress{Job: 0.8, Interest: 0.7, Aptitude: 0.6, Future: 0.5},
	}

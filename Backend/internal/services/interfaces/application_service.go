...
type ApplicationService interface {
	...
	UpdateStatus(applicationID uint, userID uint, status string, notes *string, isAdmin bool) (*entity.UserApplicationStatus, error)
	...
	ListForAdmin(userID, companyID uint, status string, schoolID *uint) ([]*entity.UserApplicationStatus, error)
	OwnerSchoolID(applicationID uint) (*uint, error)
	ListForOwner(userID, companyID uint, status string) ([]*entity.UserApplicationStatus, error)
	UpdateStatusAsOwner(applicationID, userID uint, status string, notes *string) (*entity.UserApplicationStatus, error)

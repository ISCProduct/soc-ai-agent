...
type ResumeService interface {
	...
	ReviewDocument(ctx context.Context, documentID uint, requestingUserID uint, companyName, jobTitle, candidateType string) (*models.ResumeReview, []models.ResumeReviewItem, error)

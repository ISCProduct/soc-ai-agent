...
//
// 実行: cd Backend && go test ./internal/controllers/insight/... -run CollectiveInsight -v
...
func TestCollectiveInsightController_GetRecommendations_Unauthorized(t *testing.T) {
	...
	testsupport.AssertStatus(t, insightcontrollers.NewCollectiveInsightController(nil).GetRecommendations, testsupport.NewCtx(req, rec), http.StatusUnauthorized)
}
...
func TestCollectiveInsightController_GetRecommendations_MissingSessionID(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, insightcontrollers.NewCollectiveInsightController(nil).GetRecommendations, testsupport.NewCtx(req, rec), http.StatusBadRequest)
}
...
func TestCollectiveInsightController_GetRecommendations_ServiceError(t *testing.T) {
	...
	req = testsupport.WithUserID(req, 1)
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, newCollectiveInsightController(svc).GetRecommendations, testsupport.NewCtx(req, rec), http.StatusInternalServerError)
...
func TestCollectiveInsightController_GetRecommendations_Success(t *testing.T) {
	...
	req = testsupport.WithUserID(req, 1)
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, newCollectiveInsightController(svc).GetRecommendations, testsupport.NewCtx(req, rec), http.StatusOK)
...
func TestCollectiveInsightController_GetTopPassRateCompanies_ServiceError(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, newCollectiveInsightController(svc).GetTopPassRateCompanies, testsupport.NewCtx(req, rec), http.StatusInternalServerError)
	svc.AssertExpectations(t)
}
...
func TestCollectiveInsightController_GetTopPassRateCompanies_Success(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/collective-insights/top-companies", nil)
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, newCollectiveInsightController(svc).GetTopPassRateCompanies, testsupport.NewCtx(req, rec), http.StatusOK)
	svc.AssertExpectations(t)
}
...
func TestCollectiveInsightController_UpdateConsent_Unauthorized(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, insightcontrollers.NewCollectiveInsightController(nil).UpdateConsent, testsupport.NewCtx(req, rec), http.StatusUnauthorized)
}
...
func TestCollectiveInsightController_UpdateConsent_InvalidBody(t *testing.T) {
	...
	req = testsupport.WithUserID(req, 1)
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, insightcontrollers.NewCollectiveInsightController(nil).UpdateConsent, testsupport.NewCtx(req, rec), http.StatusBadRequest)
}
...
func TestCollectiveInsightController_UpdateConsent_Success(t *testing.T) {
	...
	req = testsupport.WithUserID(req, 1)
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, newCollectiveInsightController(svc).UpdateConsent, testsupport.NewCtx(req, rec), http.StatusOK)
...
func TestCollectiveInsightController_RecordAction_Unauthorized(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, insightcontrollers.NewCollectiveInsightController(nil).RecordAction, testsupport.NewCtx(req, rec), http.StatusUnauthorized)
}
...
func TestCollectiveInsightController_RecordAction_InvalidBody(t *testing.T) {
	...
	req = testsupport.WithUserID(req, 1)
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, insightcontrollers.NewCollectiveInsightController(nil).RecordAction, testsupport.NewCtx(req, rec), http.StatusBadRequest)
}
...
func TestCollectiveInsightController_RecordAction_Success(t *testing.T) {
	...
	req = testsupport.WithUserID(req, 1)
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, newCollectiveInsightController(svc).RecordAction, testsupport.NewCtx(req, rec), http.StatusCreated)
	svc.AssertExpectations(t)
}
...
func TestCollectiveInsightController_RebuildSummaries_ServiceError(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, newCollectiveInsightController(svc).RebuildSummaries, testsupport.NewCtx(req, rec), http.StatusInternalServerError)
	svc.AssertExpectations(t)
}
...
func TestCollectiveInsightController_RebuildSummaries_Success(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/admin/collective-insights/rebuild-summaries", nil)
	rec := httptest.NewRecorder()
	testsupport.AssertStatus(t, newCollectiveInsightController(svc).RebuildSummaries, testsupport.NewCtx(req, rec), http.StatusOK)
	svc.AssertExpectations(t)
}
